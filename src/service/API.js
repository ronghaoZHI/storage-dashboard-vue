...
export const SSO_CHECK_LOGIN = (callback = '') => `http://uc.baishancloud.com/web/user/checkLogin?appId=6&language=1`
export const SSO_LOGOUT = `http://uc.baishancloud.com/web/user/logout?appId=6&language=1`
