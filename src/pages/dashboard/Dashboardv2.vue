                    ...
                    <div class="traffic">
                        <div class="upload-traffic">
                            <div class="content">
                                ...
                                <p>{{ $t("DASHBOARD.UPLOAD_SPACE_ALL")}}</p>
                            </div>
                        </div>
                        <div class="download-traffic">
                            <div class="content">
                                ...
                                <p>{{ $t("DASHBOARD.DOWNLOAD_SPACE_ALL")}}</p>
                            </div>
                        </div>
                    </div>
                </Col>
                    ...
                    <div class="view-card">
                        <div>
                            ...
                            <div class="content">
                                ...
                                <p>{{ $t("DASHBOARD.DOWNLOAD_COUNT_ALL")}}</p>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="content">
                                ...
                                <p>{{ $t("DASHBOARD.UPLOAD_COUNT_ALL")}}</p>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="content">
                                ...
                                <p>{{ $t("DASHBOARD.DELETE_COUNT_ALL")}}</p>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="content">
                                ...
                                <p>{{ $t("DASHBOARD.DELETE_SPACE_ALL")}}</p>
                            </div>
                        </div>
                    </div>
                </Col>
