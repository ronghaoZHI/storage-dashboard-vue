  ...
  <div>
    <div class="setting-box">
      ...
      <Tooltip placement="bottom"
               :content="$t('STORAGE.ADULT_OPEN_INFO')"
               :disabled="!enabledVertify">
        <i-switch size="large"
                  :disabled="enabledVertify"
                  v-model="adultPolify.enabled">
    ...
    <div class="setting-box">
      ...
      <Select v-model="adultPolify.isolate_bucket"
              class="my-select"
              style="">
      ...
      <p class="tips">{{$t('STORAGE.ADULT_SAVE_TIPS')}}
        <span @click="createBucketModal = true"
              class="creat-bucket">{{$t('STORAGE.ADULT_CREATE_BUCKET')}}</span>
      </p>
    </div>
    <div class="setting-box">
      <span class="setting-name last-title">{{$t('STORAGE.ADULT_RULE')}}</span>
      <Radio-group v-model="adultPolify.delete"
                   vertical>
        <Radio label="F">
