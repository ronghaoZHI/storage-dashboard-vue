...
export default {
    data () {
        return {
            ...
            videoCodecList: [{name: '不变', value: 'auto', container: ['flac', 'flv', 'gif', 'mp3', 'mp4', 'mpg', 'ts']}, {name: 'gif', value: 'gif', container: ['gif']}, {name: 'H.264', value: 'H.264', container: ['flv', 'mp4', 'ts']}, {name: 'H.265', value: 'H.265', container: ['flv', 'mp4', 'ts']}, {name: 'mpeg2', value: 'mpeg2', container: ['mpg']}],
            ...
            audioCodecList: [{name: '不变', value: 'auto', container: ['flac', 'flv', 'gif', 'mp3', 'mp4', 'mpg', 'ts']}, {name: 'AAC', value: 'AAC', container: ['flac', 'mp4', 'ts']}, {name: 'mp3', value: 'mp3', container: ['flv', 'mp4', 'ts']}, {name: 'mp2', value: 'mp2', container: ['mpg']}],
